...
def lambda_handler(event, context):
    ...
    try:
        ...
        D = req_body['d']  # shots per R
        H = req_body['h']  # history per signal
        T = req_body['t']  # type of signal to consider (Buy or Sell)
        P = req_body['p']  # Profitability time horizon
